...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 15 mai 2024 à 13:33
...
(4, '2', 'admin', 'hello admin tony', '2024-02-12 07:05:54'),
(18, 'admin', '9', 'bonjour', '2024-05-15 11:26:50'),
(19, 'admin', '9', 'bonjour', '2024-05-15 11:31:27'),
(20, 'admin', '9', 'cava', '2024-05-15 11:31:31'),
(21, 'admin', '2', 'salut', '2024-05-15 11:32:13'),
(22, 'admin', '2', 'cava', '2024-05-15 11:32:20');
...
CREATE TABLE `login` (
  ...
  `reset_code` mediumtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `login` (`id`, `name`, `email`, `password`, `role`, `date_created`, `reset_code`) VALUES
(1, 'SuperAdmin', 'admin@yahoo.fr', '123456', 1, '2024-01-30 14:57:12', ''),
(4, 'ahmed ahmed', 'client@yahoo.fr', '123456', 3, '2024-01-30 21:00:51', ''),
(9, 'livreur', 'livreur@yahoo.fr', '123456', 2, '2024-02-09 19:02:00', ''),
(20, 'aymen199719@hotmail.fr', 'aymen199719@hotmail.fr', '23850721', 1, '2024-05-14 21:42:14', ''),
(21, 'asma@yahoo.fr', 'asma@yahoo.fr', 'asma@yahoo.fr', 1, '2024-05-15 13:21:10', '');
...
(9, '12', 'CARTON (10-30g)', 7, 49000, 'tunis', 'jendouba', 'manouba', 2, '#ref-230221-73875', 0, 1, '2021-02-23 00:42:57'),
(10, '23', 'test', 12, 1, 'test', 'test', 'test', 12, 'test', 123, 43, '2024-04-22 03:36:57');
...
(13, 'aymen199719@hotmail.fr', 'tunisia', 'male', '23000111', 'aymen199719@hotmail.fr', 'aymen199719@hotmail.fr', '14-05-24 @ 9:42 PM');
